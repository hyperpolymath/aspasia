...
git clone <https://github.com/hyperpolymath/aspasia.git> cd aspasia
...
toolbox create aspasia-dev toolbox enter aspasia-dev \# Install
...
aspasia/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \# Library
