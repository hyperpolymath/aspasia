...
Aspasia a harassment-free experience for everyone, regardless of age,
...
. The Aspasia maintainers will review the report
...
The Aspasia maintainers will follow these guidelines in determining
consequences:
...
* Appeals are reviewed by a different Aspasia maintainers member than
the original
...
* Open a
https://github.com/hyperpolymath/aspasia/discussions[Discussion] (for
general questions)
