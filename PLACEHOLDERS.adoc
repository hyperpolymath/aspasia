...
|===
|Placeholder |Description |Example |Files
|`+Aspasia+` |Human-readable project name |`+My Project+` |SECURITY.md,
CODE_OF_CONDUCT.md, TOPOLOGY.md, STATE.a2ml, Justfile, GOVERNANCE.md,
MAINTAINERS.md, flake.guix, devcontainer.json

|`+{{PROJECT_DESCRIPTION}}+` |One-line description |`+A tool for X+`
|flake.guix

|`+ASPASIA+` |Uppercase identifier (for Idris2 modules, C macros)
...
|`+aspasia+` |Repository name (slug) |`+my-project+` |CONTRIBUTING.md,
