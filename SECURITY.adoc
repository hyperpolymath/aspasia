...
[arabic]
. Navigate to
https://github.com/hyperpolymath/aspasia/security/advisories/new[Report
a Vulnerability]
...
|*PGP Key* |link:TBD[Download Public Key]
|*Fingerprint* |`+TBD+`
|===
...
https://github.com/hyperpolymath/aspasia/security/advisories[Security
Advisories]
...
|*General questions*
|https://github.com/hyperpolymath/aspasia/discussions[GitHub
Discussions]
...
_Thank you for helping keep Aspasia and its users safe._ 🛡️
