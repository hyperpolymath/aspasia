...
============================================================================
Replace all aspasia values with your information:
  ...
  https://github.com/hyperpolymath/aspasia          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/aspasia/security/advisories/new)
...
- This repository (`hyperpolymath/aspasia`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/aspasia/security/advisories)
...
When using Aspasia, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/aspasia/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/aspasia/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/aspasia/discussions) |
...
*Thank you for helping keep Aspasia and its users safe.* 🛡️
