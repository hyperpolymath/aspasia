...
Replace all {{PLACEHOLDER}} values with your information:
  ...
  https://github.com/hyperpolymath/elenchus          - Your website/domain
...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/elenchus/security/advisories/new)
...
- This repository (`hyperpolymath/elenchus`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/elenchus/security/advisories)
...
When using Elenchus, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/elenchus/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/elenchus/security/advisories/new) or jonathan.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/elenchus/discussions) |
...
*Thank you for helping keep Elenchus and its users safe.* 🛡️
